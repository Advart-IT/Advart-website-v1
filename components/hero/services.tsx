...
export default function ServicesSection() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-black bg-[#F6F7F9] py-20 sm:py-12 md:py-16 lg:pt-20 xl:py-24 px-8">
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-black/70 text-sm sm:text-base leading-relaxed">
                      {card.tooltip.length > 150 ? <>{card.tooltip.substring(0, 150)}… </> : card.tooltip}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-4 gap-6">
          {cards.map((card, index) => (
            <div key={index} className="relative">
              <div
                onClick={() => setActive(card)}
                className="w-full rounded-2xl border border-black/10 shadow-lg bg-white cursor-pointer p-6 min-h-80 flex items-center justify-center hover:shadow-xl transition-shadow duration-200"
                title={card.tooltip}
              >
