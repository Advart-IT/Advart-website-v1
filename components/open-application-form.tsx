...
//         </div>
//       ) : (
//         <form className="space-y-4" aria-label="Open job application form">
//           <div>
...
//     <label
//       htmlFor="resume"
//       className="cursor-pointer rounded-md bg-black px-4 py-2 text-sm font-medium text-white hover:bg-white hover:text-black border border-black"
//     >
//       Choose File
//     </label>
...
//       {form.resumeName || "No file chosen"}
//     </span>
//   </div>
