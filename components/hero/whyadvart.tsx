...
const WhyAdvart = () => {
  ...
  const whyText =
    "Why Advart? Because we pair measurable outcomes with bold storytelling. We move fast, test relentlessly, and scale what works so your brand wins where it matters most."

  const words = whyText.split(" ")
  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full text-center relative z-10">
        <h2 className="mb-6 text-sm tracking-[0.3em] uppercase text-neutral-400">
          Why Advart
        </h2>
        <div
          ref={textRef}
