      ...
      {tabs.map((tab, idx) => {
        ...
        return (
          <motion.div
            ...
            className={cn("w-full h-full absolute top-0 left-0 rounded-2xl overflow-hidden", className)}
          >
            {tab.content}
          </motion.div>
        )
  ...
  return (
    <Link href="/dot" prefetch={false} className="block w-full h-full">
      <div className="w-full h-full overflow-hidden bg-black">
        <video autoPlay loop muted playsInline preload="metadata" className="w-full h-full object-contain bg-white">
  ...
  return (
    <MotionConfig reducedMotion="user" transition={{ type: "tween", duration: 0.35, ease: [0.22, 1, 0.36, 1] }}>
      <section
        ...
        ref={ref}
        data-section="3"
        className={cn("text-black bg-white scroll-mt-24 md:scroll-mt-32", isVisible && "visible")}
      >
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className="text-center mb-2 lg:mb-12">
              <div className="max-w-4xl mx-auto">
                {/* HEADING */}
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold tracking-tight mb-4 leading-tight">
                  We treat your <span className="font-bold">business</span> problems as ours!
                </h2>
