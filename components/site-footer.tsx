        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 text-sm text-gray-600 dark:text-gray-400 space-y-3">
              ...
              <p className="flex items-start gap-2">
                <MapPin className="w-5 h-5 text-gray-900 dark:text-gray-100 flex-shrink-0" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/home" className="hover:text-gray-900 dark:hover:text-gray-200 transition-colors">Home</a></li>
              <li><a href="/about" className="hover:text-gray-900 dark:hover:text-gray-200 transition-colors">About Us</a></li>
              <li><a href="/services" className="hover:text-gray-900 dark:hover:text-gray-200 transition-colors">Careers</a></li>
              <li><a href="/contact" className="hover:text-gray-900 dark:hover:text-gray-200 transition-colors">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/privacy" className="hover:text-gray-900 dark:hover:text-gray-200 transition-colors">Privacy Policy</a></li>
              <li><a href="/terms" className="hover:text-gray-900 dark:hover:text-gray-200 transition-colors">Terms & Conditions</a></li>
            </ul>
          </div>
